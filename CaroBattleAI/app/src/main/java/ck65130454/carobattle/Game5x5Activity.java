...
public class Game5x5Activity extends AppCompatActivity {
    ...
    // NÂNG CẤP: Thay đổi kích thước mảng nút bấm từ 4x4 lên 5x5
    private androidx.appcompat.widget.AppCompatButton[][] buttons = new androidx.appcompat.widget.AppCompatButton[5][5];
    ...
    // Biến kiểm tra xem người chơi đã bấm "Xác nhận" đóng Dialog tung xúc xắc đầu trận chưa
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // NÂNG CẤP: Trỏ chính xác về layout 5x5 mới tạo
        ...
        // ĐÃ SỬA CHUẨN: Truyền số 5 vào để kích hoạt Engine chạy ma trận 5x5 và luật thắng 5 ô liền nhau
        gameEngine = new CaroEngine(5);
        ...
        // NÂNG CẤP: Chạy vòng lặp quét đủ 5 hàng và 5 cột (25 ô cờ)
        for (int i = 0; i < 5; i++) {
            for (int j = 0; j < 5; j++) {
    ...
    // NÂNG CẤP: Quét toàn bộ ma trận 5x5 để hạ quân tự động khi hết thời gian
    ...
    private void botMakeMove() {
        ...
        if (botMove != null) {
            ...
            if (gameEngine.checkWin("O")) {
                ...
                isGameActive = false;
                saveMatchHistory("Đấu với Máy (5x5)", "Máy Thắng");
                return;
            }
            ...
            if (gameEngine.isBoardFull()) {
                ...
                isGameActive = false;
                saveMatchHistory("Đấu với Máy (5x5)", "Hòa");
                return;
            }
        }
    ...
    private void onCellClicked(int row, int col) {
        ...
        if (gameMode.equals("pvp")) {
            ...
            if (gameEngine.checkWin(currentStringPlayer)) {
                ...
                isGameActive = false;
                saveMatchHistory("Đấu với Người (5x5)", winnerName + " Thắng");
            } else if (gameEngine.isBoardFull()) {
                tvTurnStatus.setText("TRẬN ĐẤU HÒA!");
                cancelTimer();
                showGameDialog("🤝", "Bàn cờ đã đầy!\nKết quả hòa.");
                isGameActive = false;
                saveMatchHistory("Đấu với Người (5x5)", "Hòa");
            } else {
            ...
            if (gameEngine.checkWin("X")) {
                ...
                showGameDialog("🎉", "Chúc mừng!\nBạn đã thắng Máy!");
                isGameActive = false;
                saveMatchHistory("Đấu với Máy (5x5)", "Bạn Thắng");
                return;
            }
    ...
    private void resetGame() {
        ...
        // NÂNG CẤP: Dọn dẹp bảng quét đủ ma trận 5x5
        for (int i = 0; i < 5; i++) {
            for (int j = 0; j < 5; j++) {
                buttons[i][j].setText("");
            }
    ...
    private void showGameDialog(String icon, String message) {
        ...
        btnDialogConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Người chơi bấm nút đóng Dialog mở màn thành công -> Mở khóa cấm dòng chảy thời gian
